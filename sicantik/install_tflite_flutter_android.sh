...
# Flex installation
FULL_ARM_FLEX="https://github.com/am15h/tflite_flutter_plugin/releases/download/tf_2.4.1/libtensorflowlite_c_arm.so"
FULL_ARM_64_FLEX="https://github.com/am15h/tflite_flutter_plugin/releases/download/tf_2.4.1/libtensorflowlite_c_arm64_flex.so"
...
download_flex () {
    wget "$1" -O "$2"
    mkdir -p "${ANDROID_DIR}$3/"
    mv $2 "${ANDROID_DIR}$3/${ANDROID_LIB}"
}
...
download_flex ${ARM} ${FULL_ARM_FLEX} "armeabi-v7a"
download_flex ${ARM_64} ${FULL_ARM_64_FLEX} "arm64-v8a"
